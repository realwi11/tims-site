...
<head>
    ...
    <link rel="canonical" href="https://smartfiresprinklers.com/roof-replacement/" />
...
<title>Will & Hall LLC | Residential And Commercial Roof Replacement</title>
...
<style>
    .big_pic{
        background:linear-gradient(rgba(0, 0, 0, 0.4),rgba(0, 0, 0, 0.4)),url(https://smartfiresprinklers.com/img/big-background-pics/new-roof-eugene-oregon.jpg);
...
and (orientation: landscape) {
    .big_pic{
        background:linear-gradient(rgba(0, 0, 0, 0.4),rgba(0, 0, 0, 0.4)),url(https://smartfiresprinklers.com/img/big-background-pics/new-roof-installation-eugene-oregon.jpg);
        background-position: center center;
        background-size: cover;
        background-repeat: no-repeat;
        background-attachment: scroll;
...
<div class="entrance_animation_wrap"><div class="entrance_animation slide_up"><p>Never chase bad money with good money. There comes a time when repairing a roof is just not enough. Since Will & Hall is so familiar with the roofing industry, we will build you a quality - and beautiful - new roof at a beautiful low rate. Whether you want a new roof for your home or place of business - and regardless of whether you want simple and sleek, or skylights with style - Will & Hall will get it done right. We guarantee all of our work. All of our products all come with a warranty. Make no mistake, <u>there is no better choice</u>.</p></div></div>
...
<div class="hide_on_pc">
    ...
    <div class="entrance_animation_wrap"><div class="entrance_animation slide_up"><div class="single_show"><img src="https://smartfiresprinklers.com/img/new-roof-installation-eugene.jpg" alt="new roof installation eugene"></div></div></div>

    <div class="entrance_animation_wrap"><div class="entrance_animation slide_up"><div class="single_show"><img src="https://smartfiresprinklers.com/img/roof-replacement.jpg" alt="roof replacement"></div></div></div>

    <div class="entrance_animation_wrap"><div class="entrance_animation slide_up"><div class="single_show"><img src="https://smartfiresprinklers.com/img/roofer-replacing-roof.jpg" alt="roofer replacing roof"></div></div></div>

</div>

<div class="hide_on_mobile"><div class="three_pics"><div class="inner_pic_3 slide_up_scale"><img src="https://smartfiresprinklers.com/img/new-roof-installation-eugene.jpg" alt="new roof installation" style="margin-bottom: 20px;"></div><div class="inner_pic_3 slide_up_scale"><img src="https://smartfiresprinklers.com/img/roof-replacement.jpg" alt="roof replacement" style="margin-bottom: 20px;"></div><div class="inner_pic_3 slide_up_scale"><img src="https://smartfiresprinklers.com/img/roofer-replacing-roof.jpg" alt="roofer replacing roof" style="margin-bottom: 20px;"></div></div></div>
