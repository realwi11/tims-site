...
<head>
    ...
    <link rel="canonical" href="https://highridgepro.com/skylight-installation" />
...
<title>High Ridge LLC | Skylight Installation Specialists</title>
...
<style>
    .big_pic{
        background:linear-gradient(rgba(0, 0, 0, 0.4),rgba(0, 0, 0, 0.4)),url(https://highridgepro.com/img/big-background-pics/roofers-eugene-contact-m.jpg);
...
and (orientation: landscape) {
    .big_pic{
        background:linear-gradient(rgba(0, 0, 0, 0.4),rgba(0, 0, 0, 0.4)),url(https://highridgepro.com/img/big-background-pics/roofers-eugene-contact.jpg);
        background-position: center center;
        background-size: cover;
        background-repeat: no-repeat;
        background-attachment: scroll;
...
<div class="entrance_animation_wrap"><div class="entrance_animation slide_up"><p>From solar tubes (AKA solar tunnels, sun tunnels, or light tubes) to classic skylights, High Ridge will brighten your day. Transform your property with natural light and a classy, modern look. Bringing sunlight in does more than improve your look, it will save you money. Electricity costs can be brutal, and skylights will absolutely help to counteract them. Call now and we will get you set up to make some attractive and practical improvements.</p></div></div>

<div class="hide_on_pc">

    <div class="entrance_animation_wrap"><div class="entrance_animation slide_up"><div class="single_show"><img src="https://highridgepro.com/img/skylights-eugene.jpg" alt="skylights eugene"></div></div></div>

    <div class="entrance_animation_wrap"><div class="entrance_animation slide_up"><div class="single_show"><img src="https://highridgepro.com/img/skylight-repair.jpg" alt="skylight repair"></div></div></div>

    <div class="entrance_animation_wrap"><div class="entrance_animation slide_up"><div class="single_show"><img src="https://highridgepro.com/img/skylight-installation.jpg" alt="skylight installation"></div></div></div>

</div>

<div class="hide_on_mobile"><div class="three_pics"><div class="inner_pic_3 slide_up_scale"><img src="https://highridgepro.com/img/skylights-eugene.jpg" alt="skylights eugene" style="margin-bottom: 20px;"></div><div class="inner_pic_3 slide_up_scale"><img src="https://highridgepro.com/img/skylight-repair.jpg" alt="skylight repair" style="margin-bottom: 20px;"></div><div class="inner_pic_3 slide_up_scale"><img src="https://highridgepro.com/img/skylight-installation.jpg" alt="skylight installation" style="margin-bottom: 20px;"></div></div></div>
